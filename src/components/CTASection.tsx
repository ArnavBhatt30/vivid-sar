...
const CTASection = () => {
  ...
  return (
    <section className="py-36 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[600px] rounded-full bg-primary/[0.04] blur-[200px] pointer-events-none" />
        ...
        >
          <div className="glass-strong rounded-2xl sm:rounded-[2.5rem] p-8 sm:p-14 md:p-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button variant="outline" size="lg" className="press px-8 h-14 rounded-2xl text-base border-foreground/8 bg-foreground/[0.03] hover:bg-foreground/[0.06]" asChild>
