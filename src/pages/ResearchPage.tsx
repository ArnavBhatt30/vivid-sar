    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, ease }} className="text-center mb-14">
            <p className="text-xs font-medium uppercase tracking-[0.2em] text-primary/80 mb-4">Pipeline</p>
            <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.03em]">Four-Stage Architecture</h2>
          </motion.div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {steps.map((step, i) => (
                <motion.div
                  ...
                  className="glass-elevated rounded-2xl p-6 relative group hover:border-primary/20 transition-all duration-300"
                >
                  {i < steps.length - 1 && (
                  ...
                  <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center mb-4 group-hover:bg-primary/15 group-hover:scale-110 transition-all duration-300">
      ...
      <section className="py-24 bg-mesh">
        <div className="container mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, ease }} className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.03em]">Model Metrics</h2>
          </motion.div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 max-w-4xl mx-auto">
            {metrics.map((m, i) => (
              <motion.div
                ...
                className="glass-elevated rounded-2xl p-6 text-center group hover:border-primary/20 hover:shadow-[0_0_30px_-10px_hsl(217_91%_60%_/_0.2)] transition-all duration-300"
              >
                <m.icon size={20} className="text-primary mx-auto mb-3" />
                <p className="text-3xl font-extrabold tracking-[-0.03em] text-gradient-hero">{m.value}</p>
                <p className="text-xs font-semibold text-foreground/80 mt-2">{m.label}</p>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, ease }} className="text-center mb-10">
