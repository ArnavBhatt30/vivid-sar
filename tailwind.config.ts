  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px -8px hsl(217 91% 60% / 0.4)" },
          "50%": { boxShadow: "0 0 30px -5px hsl(217 91% 60% / 0.6)" },
        },
        "scan-rotate": {
      ...
      animation: {
        ...
        "ring-expand": "ring-expand 1.5s cubic-bezier(0.25,0.1,0.25,1) infinite",
      },
    },
  },
